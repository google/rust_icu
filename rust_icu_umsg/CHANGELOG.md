...
* **umsg:** add unsafe try_format method surfacing umsg_format's contract ([66ed028](https://github.com/google/rust_icu/commit/66ed028a9e060e3ff2be25d01e2c7fe53e35a3f8))
...
* **umsg:** null terminate all string arguments to umsg_format ([4cf24cb](https://github.com/google/rust_icu/commit/4cf24cb2aee20340c7d145d4bed6f7c519405262))
* **umsg:** reject too few arguments instead of reading past the varargs ([3c1d5d1](https://github.com/google/rust_icu/commit/3c1d5d1f94eddc2f32c23264f044d61a31abce2c))
* **umsg:** retry the format call when the output does not fit ([e623d85](https://github.com/google/rust_icu/commit/e623d85f23db7c6c0cadba2ebbfef496a50a52c1))
* **umsg:** retry the format call when the output does not fit ([a9483fa](https://github.com/google/rust_icu/commit/a9483faee207835f6262010ee98f60e12d59057c))
* update coverage report to reflect va_list function removal ([eaa4319](https://github.com/google/rust_icu/commit/eaa431992ed2590409f3fd2849847b27ccd3d11c))
...
* The following workspace dependencies were updated
  ...
  * dev-dependencies
    * rust_icu_ucal bumped from 5.7.0 to 5.8.0
