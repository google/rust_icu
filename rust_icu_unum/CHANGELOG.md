...
* add missing Dutch pluralization and spellout formats ([4459af4](https://github.com/google/rust_icu/commit/4459af4889a2f8561a093889af1e47376b7d89c2))
* move some test cases from sr-RS to nl-NL ([a0b18a1](https://github.com/google/rust_icu/commit/a0b18a1ece17007009809a2b49acdf206a1b51e3))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * rust_icu_uformattable bumped from 5.7.0 to 5.8.0
