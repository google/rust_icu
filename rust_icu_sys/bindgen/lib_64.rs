...
extern "C" {
    pub fn u_init_64(status: *mut UErrorCode);
}
extern "C" {
    pub fn u_cleanup_64();
}
...
>;
extern "C" {
    pub fn u_setMemoryFunctions_64(
        context: *const ::std::os::raw::c_void,
        a: UMemAllocFn,
        r: UMemReallocFn,
        f: UMemFreeFn,
...
>;
extern "C" {
    pub fn u_setAtomicIncDecFunctions_64(
        context: *const ::std::os::raw::c_void,
        inc: UMtxAtomicFn,
        dec: UMtxAtomicFn,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn ucol_openFromShortString_64(
...
extern "C" {
    pub fn ucol_getContractions_64(
...
extern "C" {
    pub fn ucol_getContractionsAndExpansions_64(
        coll: *const UCollator,
...
extern "C" {
    pub fn ucol_close_64(coll: *mut UCollator);
}
extern "C" {
    pub fn ucol_strcoll_64(
        coll: *const UCollator,
        source: *const UChar,
        sourceLength: i32,
        target: *const UChar,
...
extern "C" {
    pub fn ucol_getStrength_64(coll: *const UCollator) -> UCollationStrength;
}
extern "C" {
    pub fn ucol_setStrength_64(coll: *mut UCollator, strength: UCollationStrength);
}
extern "C" {
    pub fn ucol_getReorderCodes_64(
        coll: *const UCollator,
        dest: *mut i32,
        destCapacity: i32,
        pErrorCode: *mut UErrorCode,
...
extern "C" {
    pub fn ucol_setReorderCodes_64(
        coll: *mut UCollator,
...
extern "C" {
    pub fn ucol_getEquivalentReorderCodes_64(
        reorderCode: i32,
        dest: *mut i32,
        destCapacity: i32,
        pErrorCode: *mut UErrorCode,
...
extern "C" {
    pub fn ucol_getAvailable_64(localeIndex: i32) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn ucol_countAvailable_64() -> i32;
}
extern "C" {
    pub fn ucol_openAvailableLocales_64(status: *mut UErrorCode) -> *mut UEnumeration;
}
extern "C" {
    pub fn ucol_getKeywords_64(status: *mut UErrorCode) -> *mut UEnumeration;
}
extern "C" {
    pub fn ucol_getKeywordValues_64(
        keyword: *const ::std::os::raw::c_char,
        status: *mut UErrorCode,
    ) -> *mut UEnumeration;
}
extern "C" {
    pub fn ucol_getKeywordValuesForLocale_64(
        key: *const ::std::os::raw::c_char,
        locale: *const ::std::os::raw::c_char,
        commonlyUsed: UBool,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn ucol_getFunctionalEquivalent_64(
        result: *mut ::std::os::raw::c_char,
        resultCapacity: i32,
        keyword: *const ::std::os::raw::c_char,
        locale: *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn ucol_getRules_64(coll: *const UCollator, length: *mut i32) -> *const UChar;
}
extern "C" {
    pub fn ucol_getShortDefinitionString_64(
        coll: *const UCollator,
        locale: *const ::std::os::raw::c_char,
        buffer: *mut ::std::os::raw::c_char,
        capacity: i32,
...
extern "C" {
    pub fn ucol_normalizeShortDefinitionString_64(
        source: *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn ucol_nextSortKeyPart_64(
        coll: *const UCollator,
...
extern "C" {
    pub fn ucol_getVersion_64(coll: *const UCollator, info: *mut u8);
}
extern "C" {
    pub fn ucol_getUCAVersion_64(coll: *const UCollator, info: *mut u8);
}
extern "C" {
    pub fn ucol_mergeSortkeys_64(
        src1: *const u8,
        src1Length: i32,
        src2: *const u8,
        src2Length: i32,
...
extern "C" {
    pub fn ucol_getMaxVariable_64(coll: *const UCollator) -> UColReorderCode;
}
extern "C" {
    pub fn ucol_setVariableTop_64(
        coll: *mut UCollator,
        varTop: *const UChar,
        len: i32,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn ucol_getVariableTop_64(coll: *const UCollator, status: *mut UErrorCode) -> u32;
}
extern "C" {
    pub fn ucol_restoreVariableTop_64(coll: *mut UCollator, varTop: u32, status: *mut UErrorCode);
}
extern "C" {
    pub fn ucol_safeClone_64(
        coll: *const UCollator,
...
extern "C" {
    pub fn ucol_getLocaleByType_64(
        coll: *const UCollator,
        type_: ULocDataLocaleType,
        status: *mut UErrorCode,
    ) -> *const ::std::os::raw::c_char;
...
extern "C" {
    pub fn ucol_getTailoredSet_64(coll: *const UCollator, status: *mut UErrorCode) -> *mut USet;
}
extern "C" {
    pub fn ucol_getUnsafeSet_64(
        coll: *const UCollator,
        unsafe_: *mut USet,
        status: *mut UErrorCode,
    ) -> i32;
...
extern "C" {
    pub fn ucol_prepareShortStringOpen_64(
        definition: *const ::std::os::raw::c_char,
        forceDefaults: UBool,
        parseError: *mut UParseError,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn unum_close_64(fmt: *mut UNumberFormat);
}
extern "C" {
    pub fn unum_clone_64(fmt: *const UNumberFormat, status: *mut UErrorCode) -> *mut UNumberFormat;
}
extern "C" {
    pub fn unum_format_64(
...
extern "C" {
    pub fn unum_formatDoubleForFields_64(
...
extern "C" {
    pub fn unum_formatDoubleCurrency_64(
        fmt: *const UNumberFormat,
        number: f64,
        currency: *mut UChar,
        result: *mut UChar,
...
extern "C" {
    pub fn unum_formatUFormattable_64(
        fmt: *const UNumberFormat,
...
extern "C" {
    pub fn unum_parseDoubleCurrency_64(
        fmt: *const UNumberFormat,
        text: *const UChar,
        textLength: i32,
        parsePos: *mut i32,
...
extern "C" {
    pub fn unum_parseToUFormattable_64(
        fmt: *const UNumberFormat,
...
extern "C" {
    pub fn unum_getAvailable_64(localeIndex: i32) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn unum_countAvailable_64() -> i32;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd)]
...
extern "C" {
    pub fn unum_getAttribute_64(fmt: *const UNumberFormat, attr: UNumberFormatAttribute) -> i32;
}
extern "C" {
    pub fn unum_setAttribute_64(
...
extern "C" {
    pub fn unum_getDoubleAttribute_64(
        fmt: *const UNumberFormat,
        attr: UNumberFormatAttribute,
    ) -> f64;
}
extern "C" {
    pub fn unum_setDoubleAttribute_64(
        fmt: *mut UNumberFormat,
        attr: UNumberFormatAttribute,
        newValue: f64,
    );
...
extern "C" {
    pub fn unum_getTextAttribute_64(
        fmt: *const UNumberFormat,
...
extern "C" {
    pub fn unum_setTextAttribute_64(
        fmt: *mut UNumberFormat,
        tag: UNumberFormatTextAttribute,
...
extern "C" {
    pub fn unum_getLocaleByType_64(
        fmt: *const UNumberFormat,
        type_: ULocDataLocaleType,
        status: *mut UErrorCode,
    ) -> *const ::std::os::raw::c_char;
...
extern "C" {
    pub fn ulistfmt_open_64(
        locale: *const ::std::os::raw::c_char,
        status: *mut UErrorCode,
    ) -> *mut UListFormatter;
}
extern "C" {
    pub fn ulistfmt_close_64(listfmt: *mut UListFormatter);
}
extern "C" {
    pub fn ulistfmt_openResult_64(ec: *mut UErrorCode) -> *mut UFormattedList;
}
extern "C" {
    pub fn ulistfmt_resultAsValue_64(
        uresult: *const UFormattedList,
        ec: *mut UErrorCode,
    ) -> *const UFormattedValue;
}
extern "C" {
    pub fn ulistfmt_closeResult_64(uresult: *mut UFormattedList);
}
extern "C" {
    pub fn ulistfmt_format_64(
...
extern "C" {
    pub fn ulistfmt_formatStringsToResult_64(
        listfmt: *const UListFormatter,
        strings: *const *const UChar,
        stringLengths: *const i32,
        stringCount: i32,
...
extern "C" {
    pub fn u_formatMessageWithError_64(
        locale: *const ::std::os::raw::c_char,
        pattern: *const UChar,
        patternLength: i32,
        result: *mut UChar,
...
extern "C" {
    pub fn u_vformatMessageWithError_64(
        locale: *const ::std::os::raw::c_char,
        pattern: *const UChar,
        patternLength: i32,
        result: *mut UChar,
...
extern "C" {
    pub fn u_parseMessageWithError_64(
        locale: *const ::std::os::raw::c_char,
        pattern: *const UChar,
        patternLength: i32,
        source: *const UChar,
...
extern "C" {
    pub fn u_vparseMessageWithError_64(
        locale: *const ::std::os::raw::c_char,
        pattern: *const UChar,
        patternLength: i32,
        source: *const UChar,
...
extern "C" {
    pub fn umsg_close_64(format: *mut UMessageFormat);
}
extern "C" {
    pub fn umsg_clone_64(fmt: *const UMessageFormat, status: *mut UErrorCode) -> UMessageFormat;
}
extern "C" {
    pub fn umsg_setLocale_64(fmt: *mut UMessageFormat, locale: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn umsg_getLocale_64(fmt: *const UMessageFormat) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn umsg_applyPattern_64(
...
extern "C" {
    pub fn umsg_autoQuoteApostrophe_64(
        pattern: *const UChar,
        patternLength: i32,
        dest: *mut UChar,
        destCapacity: i32,
...
extern "C" {
    pub fn unumf_openForSkeletonAndLocale_64(
...
extern "C" {
    pub fn unumf_openForSkeletonAndLocaleWithError_64(
        skeleton: *const UChar,
        skeletonLen: i32,
        locale: *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn unumf_openResult_64(ec: *mut UErrorCode) -> *mut UFormattedNumber;
}
extern "C" {
    pub fn unumf_formatInt_64(
...
extern "C" {
    pub fn unumf_resultAsValue_64(
        uresult: *const UFormattedNumber,
        ec: *mut UErrorCode,
    ) -> *const UFormattedValue;
}
extern "C" {
    pub fn unumf_resultToString_64(
        uresult: *const UFormattedNumber,
        buffer: *mut UChar,
        bufferCapacity: i32,
        ec: *mut UErrorCode,
...
extern "C" {
    pub fn unumf_resultNextFieldPosition_64(
        uresult: *const UFormattedNumber,
...
extern "C" {
    pub fn unumf_resultGetAllFieldPositions_64(
        uresult: *const UFormattedNumber,
...
extern "C" {
    pub fn unumf_close_64(uformatter: *mut UNumberFormatter);
}
extern "C" {
    pub fn unumf_closeResult_64(uresult: *mut UFormattedNumber);
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash, PartialOrd)]
