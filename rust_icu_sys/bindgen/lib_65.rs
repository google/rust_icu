...
extern "C" {
    pub fn ulistfmt_open_65(
        locale: *const ::std::os::raw::c_char,
        status: *mut UErrorCode,
    ) -> *mut UListFormatter;
}
extern "C" {
    pub fn ulistfmt_close_65(listfmt: *mut UListFormatter);
}
extern "C" {
    pub fn ulistfmt_openResult_65(ec: *mut UErrorCode) -> *mut UFormattedList;
}
extern "C" {
    pub fn ulistfmt_resultAsValue_65(
        uresult: *const UFormattedList,
        ec: *mut UErrorCode,
    ) -> *const UFormattedValue;
}
extern "C" {
    pub fn ulistfmt_closeResult_65(uresult: *mut UFormattedList);
}
extern "C" {
    pub fn ulistfmt_format_65(
...
extern "C" {
    pub fn ulistfmt_formatStringsToResult_65(
        listfmt: *const UListFormatter,
        strings: *const *const UChar,
        stringLengths: *const i32,
        stringCount: i32,
