...
* The following workspace dependencies were updated
  * dependencies
    ...
    * rust_icu_ubrk bumped from 5.7.0 to 5.8.0
    * rust_icu_ucal bumped from 5.7.0 to 5.8.0
    * rust_icu_ucol bumped from 5.7.0 to 5.8.0
    * rust_icu_ucsdet bumped from 5.7.0 to 5.8.0
    * rust_icu_udat bumped from 5.7.0 to 5.8.0
    * rust_icu_udata bumped from 5.7.0 to 5.8.0
    ...
    * rust_icu_umsg bumped from 5.7.0 to 5.8.0
    * rust_icu_unorm2 bumped from 5.7.0 to 5.8.0
    * rust_icu_ures bumped from 5.7.0 to 5.8.0
    * rust_icu_ustring bumped from 5.7.0 to 5.8.0
    * rust_icu_utext bumped from 5.7.0 to 5.8.0
    * rust_icu_utrans bumped from 5.7.0 to 5.8.0
